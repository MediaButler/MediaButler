...
{
  const eD = MangaItem.data[0].attributes.endDate === null ? 'Still running' : MangaItem.data[0].attributes.endDate;
  const v = MangaItem.data[0].attributes.volumeCount === null ? 'No count registered' : MangaItem.data[0].attributes.volumeCount;
  const c = MangaItem.data[0].attributes.chapterCount === null ? 'No count' : MangaItem.data[0].attributes.chapterCount;
  const o = MangaItem.data[0].attributes.synopsis === null ? 'No description' : MangaItem.data[0].attributes.synopsis;
  const s = MangaItem.data[0].attributes.status === 'finished' ? 'Finished' : 'Running';
