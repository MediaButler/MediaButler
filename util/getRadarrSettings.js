...
module.exports = (guildId) =>
{
    const p = new Promise((resolve, reject) => 
    {
        ...
        .then((settings) =>
        {
            ...
            let url = settings.find(x => x.setting == "radarr.url");
            let apikey = settings.find(x => x.setting == "radarr.apikey");
            let profileid = settings.find(x => x.setting == "radarr.defaultprofileid");
            let rootpath = settings.find(x => x.setting == "radarr.defaultrootpath");                
